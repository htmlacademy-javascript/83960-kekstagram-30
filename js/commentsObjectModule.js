...
const commentsList = {
  ...
  setNumberCommentsShown() {
    document.querySelector(`.${classes.commentShownCountClass}`).textContent = this.showFromNumber;
  },
  setNumberCommentsTotal(numberTotal) {
    this.numberCommentsTotal = numberTotal;
    document.querySelector(`.${classes.commentTotalCountClass}`).textContent = numberTotal;
  },
  ...
  setCommentsLoaderButton() {
    this.commentsLoaderButton = document.querySelector(`.${classes.commentsLoaderButtonClass}`);
  ...
  init(arrayComments, numberShown) {
    ...
    this.listComments = classes.listCommentsClass;
